...
const Detail = (props) => {
    ...
    return (
        // <View>
        //     {/* <Text onPress={()=> navigation.navigate('Seach',{})}></Text> */}
        //     <Text> Tiêu đề: {newsDetail.title} </Text>
        //     <Text> Tiêu đề: {newsDetail.content} </Text>
        ...
        <View style={styles.body}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={[styles.anh,]}>
                    <Image style={{ width: 200, height: 200 }} source={{ uri: newsDetail.image }} />
                </View>
